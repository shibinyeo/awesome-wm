...
--- This function is used later. In case there are too many notifications, these oldest notifications will be deleted 
...
naughty.connect_signal("request::display", function(n)
	...
	-- local app_icon = nil
	local app_icon = "" -- added by shibin (this is a bell)
	...
	--- Define Widget: Notification Message
